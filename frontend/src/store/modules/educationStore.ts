  ...
  function initializeQuickStartSteps() {
    const steps: Omit<QuickStartStep, 'id'>[] = [
      ...
      },
      {
        ...
        description: 'این بخش در حال بازطراحی است و به‌زودی با یک سرویس هوش مصنوعی جدید در دسترس قرار می‌گیرد.',
        details: [
          'فعلاً غیرفعال است؛ نتیجهٔ محاسبات را می‌توانید در تب «محاسبه کود» مشاهده کنید'
        ],
        tips: [],
        warnings: [],
        order: 6
