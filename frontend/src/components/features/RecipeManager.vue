  ...
  <div class="space-y-6">
    ...
    >
      ...
      <div v-if="activeTab === 'system'" class="p-4 sm:p-6">
        ...
        <div
          v-else
          class="max-h-[520px] overflow-y-auto custom-scrollbar pl-1 pr-1"
        >
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <div class="flex items-start justify-between mb-3">
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-2 mt-1 flex-wrap">
                    ...
                    <span
                      class="text-[10px] px-2 py-0.5 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 rounded-full"
                    >
                      سیستمی
                    </span>
                  </div>
              ...
              <p
                ...
                class="text-xs text-gray-500 dark:text-gray-400 mb-3 line-clamp-2"
              >
                {{ recipe.description }}
              </p>
              ...
              <div class="relative mb-3">
                <div class="flex flex-wrap gap-1">
                  <span
                    v-for="(value, element) in getTopElements(
                  ...
                  >
                    ...
                    <!-- Tooltip -->
                    <div
                      class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover/tooltip:block z-50 min-w-[200px] max-w-[280px]"
                    >
                      <div
                        class="bg-gray-900 dark:bg-gray-800 text-white text-xs rounded-lg shadow-2xl p-3 border border-gray-700 dark:border-gray-600"
                      >
                        <p
                          class="font-semibold text-primary-400 mb-2 text-center"
                        >
                          تمام عناصر
                        </p>
                        ...
                        >
                          <div
                            class="border-8 border-transparent border-t-gray-900 dark:border-t-gray-800"
                          ></div>
                        </div>
                      </div>
                    </div>
      ...
      <div v-if="activeTab === 'personal'" class="p-4 sm:p-6">
        ...
        <!-- Empty State -->
        <div
          v-else-if="userRecipes.length === 0"
        ...
        >
          ...
          <p class="text-gray-500 dark:text-gray-400 mb-2">
            هنوز رسپی شخصی ندارید
          </p>

          <p class="text-xs text-gray-400 dark:text-gray-500 mb-4">
            از رسپی‌های سیستمی کپی کنید یا یک رسپی جدید بسازید
          </p>
              ...
              <div class="flex items-start justify-between mb-3">
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-2 mt-1 flex-wrap">
                    ...
                    <span
                      class="text-[10px] px-2 py-0.5 bg-success-100 dark:bg-success-900/30 text-success-700 dark:text-success-400 rounded-full"
                    >
                      شخصی
                    </span>
                  </div>
                  ...
                  <div class="overflow-x-auto">
                    <table class="w-full text-sm border-collapse">
                      <thead>
                        <tr>
                          <th
                            class="px-3 py-2 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-semibold border border-gray-200 dark:border-gray-600 text-center min-w-[80px]"
                          >
                            عنصر
                          </th>
                      ...
                      <tbody>
                        <tr>
                          <td
                            class="px-3 py-2 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-center font-medium text-gray-600 dark:text-gray-400 text-xs"
                          >
                            مقدار هدف
                          </td>
...
const saveRecipe = async () => {
  ...
  if (
    Object.keys(formData.target_values).filter(
      (key) => formData.target_values[key] > 0
    ).length === 0
  ) {
    showToast(
      'لطفاً حداقل یک عنصر با مقدار مثبت وارد کنید',
      'error'
    );
    return;
  }
  ...
  try {
    ...
    if (isEditing.value && editingId.value !== null) {
      result = await recipeStore.updateRecipe(
        editingId.value,
        data
      );
      ...
      if (userRecipes.value.length >= PERSONAL_RECIPE_LIMIT) {
        showToast(
          'ظرفیت رسپی‌های شخصی تکمیل شده است.',
          'error'
        );
        return;
      }
    ...
    showToast(
      error.message || 'خطا در ذخیره رسپی',
      'error'
    );
  } finally {
...
const applyRecipe = async (id: number) => {
  try {
    ...
    showToast(
      error.message || 'خطا در اعمال رسپی',
      'error'
    );
  }
};
...
const copyRecipe = async (id: number) => {
  ...
  try {
    ...
    if (result) {
      showToast(
        `رسپی "${result.name}" با موفقیت کپی شد`,
        'success'
      );
