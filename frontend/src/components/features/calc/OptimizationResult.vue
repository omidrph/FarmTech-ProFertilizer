          ...
          <table class="w-full text-sm border-collapse">
            ...
            <tfoot>
              <tr class="bg-gray-50 dark:bg-gray-700/50 border-t-2 border-gray-200 dark:border-gray-600">
                ...
                <td colspan="2" class="px-4 py-3 text-center font-bold text-success-600 dark:text-success-400 tabular-nums text-base">
...
const getEcStatusClass = (status: string): string => {
  const classes: Record<string, string> = {
    'مطلوب': 'bg-success-100 dark:bg-success-900/30 text-success-700 dark:text-success-400',
...
const getEcPhStatusIcon = (color: string): string => {
  const icons: Record<string, string> = {
    'success': `<svg class="w-5 h-5 text-success-600 dark:text-success-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>`,
