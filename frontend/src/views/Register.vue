      ...
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">
            برای استفاده از برنامه، حساب کاربری بسازید
          </p>
        </div>
        ...
        <Transition name="fade">
          <div v-if="registerSuccess" class="bg-success-50 dark:bg-success-900/20 border-r-4 border-success-500 rounded-lg p-3 mb-4">
            <div class="flex items-center gap-2">
              ...
              <p class="text-success-700 dark:text-success-400 text-sm font-medium">✅ ثبت‌نام با موفقیت انجام شد!</p>
            </div>
          </div>
        </Transition>
...
// اسلایدهای توضیحات - با آیکون‌های SVG و متن‌های حرفه‌ای
const slides = [
  {
    id: 1,
